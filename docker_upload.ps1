...
ssh -t jared@192.168.1.150 'docker run -d -e "VIRTUAL_HOST=v3.scripturesproject.review" -e "LETSENCRYPT_HOST=v3.scripturesproject.review" -e "LETSENCRYPT_EMAIL=jared@parkinson.im"  -p 10000 -it --rm --name scriptures_project_v3 scriptures_project_v3 '